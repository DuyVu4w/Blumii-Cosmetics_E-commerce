...
const OrderResultPage = () => {
  ...
  return (
    <>
      ...
      <div
        className="bg-white rounded-3 shadow-lg p-4 my-5 mx-auto"
      ...
      >
        ...
        {status === "loading" && (
          <div className="text-center py-5">
            ...
            <p className="mt-2">Data Loading...</p>
          </div>
        )}
          ...
          <div className="card bg-light rounded-3 border-0 shadow-sm p-3 w-100">
            ...
            <div className="row g-2 pt-3 justify-content-center">
              <div className="col-12 col-md-6">
                <Link
                  to="#"
                  className="btn border border-secondary rounded-pill py-2 text-primary w-100"
                >
                  Order details
                </Link>
              </div>
