...
const sampleCheckout = [
    { id: 1, imgSrc: "img/vegetable-item-2.jpg", name: "Awesome Brocoli", price: 69.00, quantity: 2, total: 69.00 * 2 },
    { id: 2, imgSrc: "img/vegetable-item-5.jpg", name: "Potatoes", price: 69.00, quantity: 2, total: 69.00 * 2 },
    { id: 3, imgSrc: "img/vegetable-item-3.png", name: "Big Banana", price: 69.00, quantity: 2, total: 69.00 * 2 },


]
const CheckoutPage = () => {

    const [shippingOption, setShippingOption] = useState("free"); // free, flat, pickup

    const shippingCost =
        shippingOption === "free" ? 0 :
            shippingOption === "flat" ? 15 :
                shippingOption === "pickup" ? 8 : 0;

    const subtotal = sampleCheckout.reduce(
    ...
    return (
        <>
            <PageBannerHeader title="Checkout"/>
                            ...
                            <div className="col-md-12 col-lg-6 col-xl-5">
                                <div className="table-responsive">
                                    <table className="table">
                                        ...
                                        <tbody>
                                            {/*Dữ liệu giả  */}
                                            {sampleCheckout.map((item) => (
                                                <tr key={item.id}>
                                                    <th scope="row">
                                                        <div className="d-flex align-items-center mt-2">
                                                            <img src={item.imgSrc} className="img-fluid rounded-circle" style={{ width: '90px', height: '90px' }} alt="" />
                                                        </div>
                                                    </th>
                                                    <td>{item.name}</td>
