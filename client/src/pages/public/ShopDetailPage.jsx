                            ...
                            <div className="row g-4">
                                <div className="col-lg-6">
                                    <div className="border rounded">
                                        <a href="#">
                                            <img src="img/single-item.jpg" className="img-fluid rounded" alt="Product" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="d-flex align-items-center" style={{ fontSize: '16px', cursor: 'pointer' }}>
                                                        ...
                                                        {[1, 2, 3, 4, 5].map((starValue) => (
                                                            <i
                                                                key={starValue}
                                                                className={`fa fa-star ${hoverRating >= starValue || rating >= starValue ? 'text-secondary' : 'text-muted'}`} // Template gốc dùng 'text-secondary' cho sao vàng
