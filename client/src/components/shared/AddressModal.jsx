        ...
        <>
            ...
            <div className="auth-modal-backdrop" onClick={onClose}>
                <div className="auth-modal-content" onClick={(e) => e.stopPropagation()}>
                    <h2>{isLoading ? 'Đang tải dữ liệu...' : 'Chọn Địa Chỉ Của Bạn'}</h2>

                    {/* Tỉnh/Thành phố */}
                    <div className="form-group">
                        <label htmlFor="province">Tỉnh/Thành phố</label>
                        <select id="province" value={selectedProvince} onChange={(e) => setSelectedProvince(e.target.value)} disabled={isLoading}>
                    ...
                    <div className="form-group">
                        ...
                        <select id="district" value={selectedDistrict} onChange={(e) => setSelectedDistrict(e.target.value)} disabled={!districts.length || isLoading}>
                    ...
                    <div className="form-group">
                        ...
                        <select id="ward" value={selectedWard} onChange={(e) => setSelectedWard(e.target.value)} disabled={!wards.length || isLoading}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="street" value={street} onChange={(e) => setStreet(e.target.value)} placeholder="Ví dụ: 123 Đường ABC" disabled={isLoading} />
                    </div>

                    {/* Nút bấm */}
                    <div className="auth-modal-actions">
                        <button type="button" onClick={onClose} className="ghost">Hủy</button>
                        <button type="button" onClick={handleSave}>Lưu Địa Chỉ</button>
                    </div>
                </div>
            </div>
        </>
